...
export default function Home() {
  ...
  return (
    <main className="m-3 w-full h-full flex-col justify-center content-center">
      <h1 className="p-2 my-6 text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-indigo-600 to-blue-200">
